...
<%@include file="/jsp/common/head.jsp"%>
  ...
  <div class="right">
      ...
      <div class="providerAdd">
          <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provide/domodify">
              <!--div的class 为error是验证错误，ok是验证成功-->
              <div class="">
                  <label for="proCode">供应商编码：</label>
                  <input type="text" name="proCode" id="proCode" value="${provider.proCode }" readonly="readonly">
                  <input type="hidden" name="id" id="providerid" value="${provider.id }" readonly="readonly">
              </div>
              <div>
