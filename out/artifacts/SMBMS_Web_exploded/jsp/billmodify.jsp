...
<div class="right">
        ...
        <div class="providerAdd">
          <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/sys/bill/modify">
                ...
                <div>
                    <label for="productName">商品类型：</label>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/billmodify.js?v=0.5"></script>